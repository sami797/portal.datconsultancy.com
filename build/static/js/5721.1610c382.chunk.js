"use strict";
(self["webpackChunkdat_projects"] = self["webpackChunkdat_projects"] || []).push([[5721],{
...
;// ./src/Components/Organisms/SiteSettings/BiometricsBulkUploadJob/modal.tsx
...
;// ./src/Components/Organisms/SiteSettings/BiometricsBulkUploadJob/index.tsx
// import styles from "./styles.module.scss";
const breadCrumbsData=[{text:"Home",isLink:true,path:"/"},{isLink:true,text:"Site Settings",path:"/siteSettings"},{isLink:false,text:"Biometrics Bulk Upload Job"}];// type SelectedFiltersTypes = {
// 	type: string;
// 	slug: string;
// 	locationUrl: string;
// 	country: number;
...
const permissionSlug=(0,common/* getPermissionSlugs */.AH)(Job_permissions/* BulkUploadJobPermissionsEnum */.Y);const{userPermissions}=(0,es/* useSelector */.d4)(state=>state.usersReducer);const permissions=userPermissions;const{readBiometricsJob,createBiometricsJob,updateBiometricsJob}=permissions;const[currentEditType,setcurrentEditType]=(0,react.useState)({editType:"new",recordId:0,openModal:false});const module=(0,react.useMemo)(()=>new Job/* BiometricsBulkUploadJobModule */.W(),[]);const[searchTerm,setSearchTerm]=(0,react.useState)("");const debouncedSearchTerm=(0,useDebounce/* useDebounce */.d)(searchTerm,500);// const [selectedFilters, setSelectedFilters] = useState<SelectedFiltersTypes>({
// 	type: "",
// 	slug: "",
// 	country: 0,
// 	locationUrl: "",
...
return/*#__PURE__*/(0,jsx_runtime.jsxs)(SiteSettings["default"],{permissionSlug:permissionSlug,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* PageHeader */.zY,{heading:"Biometrics Bulk Upload Job",buttonText:"New Upload Job",onButtonClick:onCancelClick,breadCrumbData:breadCrumbsData,showAdd:createBiometricsJob===true?true:false// filters={
// 	<div>
// 		<div>
// 			<CustomInput
// 				placeHolder='Search...'
