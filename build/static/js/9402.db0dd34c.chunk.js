"use strict";
(self["webpackChunkdat_projects"] = self["webpackChunkdat_projects"] || []).push([[9402],{
...
;// ./src/Components/Organisms/Dashboard/ViewRolePermissions/styles.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const styles_module = ({"rolePermissionAsideContainer":"styles_rolePermissionAsideContainer__0d+3p","active":"styles_active__Hr+R-","sideBarHeading":"styles_sideBarHeading__mXu-t","adminNavPanelsWrap":"styles_adminNavPanelsWrap__0ez0u","textWithIcon":"styles_textWithIcon__SVjV9","textWithIcon__rev":"styles_textWithIcon__rev__LI08c","collapse":"styles_collapse__UatTo","collapse__normal":"styles_collapse__normal__eBU1W","divider":"styles_divider__DkzjN","translated":"styles_translated__ZWlVA","animateTranslation":"styles_animateTranslation__b6uN9","__translate":"styles___translate__2j-ba","negAnimateTranslation":"styles_negAnimateTranslation__A2E0r","__negTranslate":"styles___negTranslate__5dhTE","header":"styles_header__sYQjE","content":"styles_content__3OpQb","contentHeader":"styles_contentHeader__FFVi-","content__layout":"styles_content__layout__VI1zG","content__layout__header":"styles_content__layout__header__btHqN","content__layout__content":"styles_content__layout__content__hr3nH","content__layout__footer":"styles_content__layout__footer__4qSS1","content__layout__footer__button":"styles_content__layout__footer__button__4BAfP","actions":"styles_actions__tt8KG","bg__red":"styles_bg__red__L0PF6","form":"styles_form__I+HR-","footer":"styles_footer__Z55O2","opacity_6":"styles_opacity_6__y0pT8"});
...
const findRoleData=(0,react.useCallback)(()=>{if(Number(roleId)!==0){const roleData=roles.data.find(item=>item.id===Number(roleId));setSelectedRoleData(roleData);}},[roleId,roles.data]);(0,react.useEffect)(()=>{findRoleData();},[findRoleData]);return/*#__PURE__*/(0,jsx_runtime.jsxs)(Layout/* default */.A,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* PageHeader */.zY,{heading:"Role Permissions",breadCrumbData:breadCrumbsData}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"d-flex overflow-hidden",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"d-flex flex-column w-100",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:styles_module.header+" d-flex pb-4",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"my-auto color-dark-main",children:"You are viewing permission of"}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"ml-3",children:/*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A,{onChange:value=>setRoles((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},roles),{},{selectedId:value})),placeholder:"Choose role",allowClear:true,style:{width:200},className:"selectAntdCustom",loading:roles.loading,options:roles.data.map(role=>{return{label:role.title,value:role.id};}),defaultValue:Number(roleId)&&Number(roleId)!==0?Number(roleId):null})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"overflow-auto",children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{children:permission.loading?/*#__PURE__*/(0,jsx_runtime.jsx)(Skeletons/* default */.A,{items:16}):!Number(roleId)||systemModulesData.data.length===0?/*#__PURE__*/(0,jsx_runtime.jsx)(empty/* default */.A,{image:"https://gw.alipayobjects.com/zos/antfincdn/ZHrcdLPrvN/empty.svg",imageStyle:{height:200},description:/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:"Please select a role to view the associated permissions"})}):/*#__PURE__*/(0,jsx_runtime.jsx)("div",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(TableComponent,{tableData:systemModulesData.data,tableLoading:systemModulesData.loading,rolePermissions:privilegesData,roleData:selectedRoleData})})})})]})})]});};/* harmony default export */ const ViewRolePermissions = (AgentRolePermissions);
