(self["webpackChunkdat_projects"] = self["webpackChunkdat_projects"] || []).push([[3784],{
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ MyServices_CarReservation)
});
...
// EXTERNAL MODULE: ./src/Components/Organisms/Dashboard/MyServices/CarReservation/styles.module.scss
var styles_module = __webpack_require__(57088);
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(9950);
// EXTERNAL MODULE: ./node_modules/antd/es/message/index.js + 1 modules
var message = __webpack_require__(92759);
...
var InternalTimePicker = date_picker/* default */.A.TimePicker,
  InternalRangePicker = date_picker/* default */.A.RangePicker;
var RangePicker = /*#__PURE__*/react.forwardRef(function (props, ref) {
  var dropdownClassName = props.dropdownClassName,
    popupClassName = props.popupClassName;
  return /*#__PURE__*/react.createElement(InternalRangePicker, (0,esm_extends/* default */.A)({}, props, {
...
var TimePicker = /*#__PURE__*/react.forwardRef(function (_a, ref) {
  ...
  return /*#__PURE__*/react.createElement(InternalTimePicker, (0,esm_extends/* default */.A)({
    dropdownClassName: dropdownClassName,
    popupClassName: popupClassName
  }, restProps, {
    mode: undefined,
...
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(44414);
;// ./src/Components/Organisms/Dashboard/MyServices/CarReservation/create.tsx
const CarReservationModal=props=>{const{openModal,onCancel,reloadTableData,permissions:{createcarReservationRequest}}=props;const[form]=es_form/* default */.A.useForm();const module=new CarReservation/* CarReservationModule */.n();const projectModule=new Project/* ProjectModule */.K();const[recordData,setRecordData]=(0,react.useState)();// Project Search Term
...
const onProjectSearch=()=>{if(debouncedSearchTermProject){projectModule.getAllRecords({title:debouncedSearchTermProject}).then(res=>{const{data}=res;setProjectOptions(prev=>{var _data$data;// if the data is already present in the state, then don't add it again
...
return[...prev,...filteredData];});}).catch(err=>{var _err$response,_err$response$data;message/* default */.Ay.error(err===null||err===void 0?void 0:(_err$response=err.response)===null||_err$response===void 0?void 0:(_err$response$data=_err$response.data)===null||_err$response$data===void 0?void 0:_err$response$data.message);});}};(0,react.useEffect)(()=>{onProjectSearch();},[debouncedSearchTermProject]);const handleErrors=err=>{const error=(0,error_handler/* errorHandler */.r)(err);if(typeof error.message=="string"){setRecordData((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},recordData),{},{error:error.message}));}else{let errData=(0,ServerErrorHandler/* HandleServerErrors */.p)(error.message,[]);form.setFields(errData);setRecordData((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},recordData),{},{error:""}));}};const handleAlertClose=()=>{setRecordData((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},recordData),{},{error:""}));};(0,react.useEffect)(()=>{form.resetFields();},[openModal]);const onFinish=formValues=>{setRecordData((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},recordData),{},{buttonLoading:true}));const{files}=formValues;const requestData={companyCarId:formValues.companyCarId,fromDate:formValues.date._d.toISOString().substring(0,10)+formValues.checkIn._d.toISOString().substring(10),toDate:formValues.date._d.toISOString().substring(0,10)+formValues.checkOut._d.toISOString().substring(10)};module.checkAvailability(requestData).then(res=>{if(res.data.data.isAvailable){var _files$fileList;const formData=new FormData();const excludeFields=["files","checkIn","checkOut"];Object.entries(formValues).forEach(ele=>{if(!excludeFields.includes(ele[0])){if(ele[0]==="date"){formData.append("fromDate",formValues.date._d.toISOString().substring(0,10)+formValues.checkIn._d.toISOString().substring(10));formData.append("toDate",formValues.date._d.toISOString().substring(0,10)+formValues.checkOut._d.toISOString().substring(10));}else formData.append(ele[0],ele[1]);}});// add files to form data 
const _files=files===null||files===void 0?void 0:(_files$fileList=files.fileList)===null||_files$fileList===void 0?void 0:_files$fileList.map(file=>{return file.originFileObj;});if(_files!==null&&_files!==void 0&&_files.length){for(let i=0;i<_files.length;i++){formData.append('files[]',_files[i]);}}if(createcarReservationRequest===true){module.createRecord(formData).then(res=>{reloadTableData();onCancel();setRecordData(prev=>(0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},prev),{},{buttonLoading:false}));}).catch(err=>{handleErrors(err);setRecordData(prev=>(0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},prev),{},{buttonLoading:false}));});}else{setRecordData(prev=>(0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},prev),{},{buttonLoading:false}));message/* default */.Ay.error("You don't have permission to create this record");}}else{message/* default */.Ay.error("The car is already booked for these dates");}}).catch(err=>{message/* default */.Ay.error("Something went wrong");setRecordData((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},recordData),{},{buttonLoading:false}));});};// eslint-disable-next-line arrow-body-style
const disabledDate=current=>{// Can not select days before today and today
return current&&current<moment_default()().endOf('day').subtract(1,'day');};return/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* CustomModal */.jo,{visible:openModal,closable:true,onCancel:onCancel,titleText:"Add New Request",showFooter:false,children:recordData!==null&&recordData!==void 0&&recordData.loading?/*#__PURE__*/(0,jsx_runtime.jsx)(Skeletons/* default */.A,{items:10}):/*#__PURE__*/(0,jsx_runtime.jsxs)(es_form/* default */.A,{className:Common_styles_module/* default */.A.form,onFinish:onFinish,form:form,children:[(recordData===null||recordData===void 0?void 0:recordData.error)&&/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* CustomErrorAlert */.WZ,{description:recordData===null||recordData===void 0?void 0:recordData.error,isClosable:true,onClose:handleAlertClose}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(es_form/* default */.A.Item,{name:"purpose",rules:[{required:true,message:"Please add a purpose"}],children:/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* CustomInput */.wi,{size:"w100",label:"Purpose",asterisk:true,type:"textArea",placeHolder:"Enter Purpose"})})}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{width:'100%'},children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("label",{style:{fontSize:'var(--font-size-sm)',color:'var(--color-dark-main)',width:'33%'},children:["Date",/*#__PURE__*/(0,jsx_runtime.jsx)("span",{style:{color:'var(--color-red-yp)'},children:" *"}),/*#__PURE__*/(0,jsx_runtime.jsx)(es_form/* default */.A.Item,{name:"date",rules:[{required:true,message:"Please select date "}],children:/*#__PURE__*/(0,jsx_runtime.jsx)(date_picker/* default */.A,{disabledDate:disabledDate,style:{borderRadius:'0.25rem',borderWidth:2,width:'100%',borderColor:'var(--color-border)'}})})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("label",{style:{fontSize:'var(--font-size-sm)',color:'var(--color-dark-main)',width:'33%'},children:["From",/*#__PURE__*/(0,jsx_runtime.jsx)("span",{style:{color:'var(--color-red-yp)'},children:" *"}),/*#__PURE__*/(0,jsx_runtime.jsx)(es_form/* default */.A.Item,{name:"checkIn",rules:[{required:true,message:"Please select date "}],children:/*#__PURE__*/(0,jsx_runtime.jsx)(time_picker,{showSecond:false,minuteStep:15,style:{borderRadius:'0.25rem',borderWidth:2,width:'100%',borderColor:'var(--color-border)'}})})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("label",{style:{fontSize:'var(--font-size-sm)',color:'var(--color-dark-main)',width:'33%'},children:["To",/*#__PURE__*/(0,jsx_runtime.jsx)("span",{style:{color:'var(--color-red-yp)'},children:" *"}),/*#__PURE__*/(0,jsx_runtime.jsx)(es_form/* default */.A.Item,{name:"checkOut",rules:[{required:true,message:"Please select date "}],children:/*#__PURE__*/(0,jsx_runtime.jsx)(time_picker,{showSecond:false,minuteStep:15,style:{borderRadius:'0.25rem',borderWidth:2,width:'100%',borderColor:'var(--color-border)'}})})]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(es_form/* default */.A.Item,{className:"color-dark-main",name:"projectId",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* SelectWithSearch */.fd,{label:"Select Project",notFoundDescription:"No projects found., Please search for projects.",onSearch:value=>setSearchTermProject(value),options:projectOptions===null||projectOptions===void 0?void 0:projectOptions.map(item=>({label:"".concat(item.referenceNumber," | ").concat(item.title),value:item.id})),onChange:value=>form.setFieldsValue({projectId:value}),asterisk:false})})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* ImageUploader */.GA,{name:"files",required:false,multiple:true})}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"d-flex justify-end mt-4",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* CustomButton */.Sv,{size:"normal",fontSize:"sm",onClick:onCancel,type:"plain",children:"Cancel"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* CustomButton */.Sv,{type:"primary",size:"normal",fontSize:"sm",htmlType:"submit",loading:recordData===null||recordData===void 0?void 0:recordData.buttonLoading,children:"Add Request"})]})]})});};
...
;// ./src/Components/Organisms/Dashboard/MyServices/CarReservation/index.tsx
const breadCrumbsData=[{text:"Home",isLink:true,path:"/"},{isLink:true,text:"My Services",path:"/myservices"},{isLink:false,text:"Car Reservation Request"}];const CarReservation_CarReservation=()=>{// available permissions for the properties page
const permissionSlug=(0,common/* getPermissionSlugs */.AH)(CarReservation_permissions/* CarReservationPermissionsEnum */.y);const{userPermissions}=(0,es/* useSelector */.d4)(state=>state.usersReducer);const permissions=userPermissions;const{createcarReservationRequest}=permissions;const[currentEditType,setcurrentEditType]=(0,react.useState)({recordId:0,openModal:false});const[openDrawer,setOpenDrawer]=(0,react.useState)(false);const[filters,setFilters]=(0,react.useState)({page:1,perPage:6});const module=(0,react.useMemo)(()=>new CarReservation/* CarReservationModule */.n(),[]);const{data,onRefresh,setData,loading,meta}=(0,hooks/* useFetchData */.Gs)({method:module.getOwnRecords,initialQuery:(0,objectSpread2/* default */.A)({},filters)});const onCancelClick=()=>{if(createcarReservationRequest===false){message/* default */.Ay.error("You don't have permission to create new record");return;}setcurrentEditType((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},currentEditType),{},{openModal:!currentEditType.openModal}));};//user search
...
return[...prev,...filteredData];});}).catch(err=>{message/* default */.Ay.error(err.response.data.message);});}},[debouncedSearchTermUser]);(0,react.useEffect)(()=>{onUserSearch();},[onUserSearch]);return/*#__PURE__*/(0,jsx_runtime.jsxs)(Layout/* default */.A,{permissionSlug:permissionSlug,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* PageHeader */.zY,{heading:"Car Reservation Request",breadCrumbData:breadCrumbsData,showAdd:createcarReservationRequest===true?true:false,buttonText:"New Request",onButtonClick:onCancelClick}),/*#__PURE__*/(0,jsx_runtime.jsx)("section",{className:styles_module/* default */.A.container,children:loading?[...new Array(6)].map((_,index)=>/*#__PURE__*/(0,jsx_runtime.jsx)(CardShimmer/* CardShimmer */.S,{},"shimmer".concat(index))):(data===null||data===void 0?void 0:data.length)!==0?data===null||data===void 0?void 0:data.map((carReservation,index)=>/*#__PURE__*/(0,jsx_runtime.jsx)(card/* CarReservationCard */.V,{carReservation:carReservation,onClick:()=>{setcurrentEditType((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},currentEditType),{},{recordId:carReservation.id}));setOpenDrawer(true);}},index)):/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{margin:'auto'},children:/*#__PURE__*/(0,jsx_runtime.jsx)(Atoms/* CustomEmpty */.ZX,{description:"No requests found for the given filters"})})}),/*#__PURE__*/(0,jsx_runtime.jsx)(pagination/* default */.A,{hideOnSinglePage:true,current:meta===null||meta===void 0?void 0:meta.page,total:meta===null||meta===void 0?void 0:meta.total,pageSize:(meta===null||meta===void 0?void 0:meta.perPage)||0,onChange:(page,pageSize)=>{onRefresh((0,objectSpread2/* default */.A)((0,objectSpread2/* default */.A)({},filters),{},{page:page,perPage:pageSize}));},style:{alignSelf:"flex-end"}}),openDrawer&&/*#__PURE__*/(0,jsx_runtime.jsx)(CarReservationDrawer/* CarReservationDrawer */.a,{openDrawer:openDrawer,onClose:()=>setOpenDrawer(false),permissions:permissions,record:currentEditType.recordId,reloadTableData:onRefresh}),/*#__PURE__*/(0,jsx_runtime.jsx)(CarReservationModal,{reloadTableData:onRefresh,onCancel:onCancelClick,openModal:currentEditType.openModal,permissions:permissions})]});};/* harmony default export */ const MyServices_CarReservation = (CarReservation_CarReservation);
