...
// Define the response type for fetchOverallPaymentStatus
export interface OverallPaymentStatusResponse {
	status: string; // Adjust this type according to your actual response
  }
