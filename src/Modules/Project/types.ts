...
// Assuming these are the Xero-related fields you want to include
export type ProjectTypes = {
  ...
  xeroReference: string;  // Xero reference field
  totalExpenseAmount?: { currency: string; value: number };  // Xero expense amount
  totalInvoiced?: { currency: string; value: number };  // Xero invoiced amount
  estimate?: { currency: string; value: number };  // Xero estimate amount
  contactId?: string;
  projectId: string;
  status: string;
  name: string;
