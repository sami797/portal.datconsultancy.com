...
type SegmentedStatusTypes = "all" | "active" | "paid" | "draft" | "canceled" | "hasConcerns" | "draftn"
...
const Invoices: FC = () => {
  ...
  const segmentedOptions: { label: string; value: SegmentedStatusTypes }[] = [
    ...
    { label: `Pending Draft (${statusCounts?.draftn|| 0})`, value: "draftn" },
